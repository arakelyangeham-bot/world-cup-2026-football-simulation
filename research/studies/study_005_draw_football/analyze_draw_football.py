...
OUTPUT_DIR = (
    ...
    / "research"
    / "studies"
    / "study_005_draw_football"
)
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

PROFILE_OUTPUT_PATH = OUTPUT_DIR / "draw_profile_summary.csv"
COMPARISON_OUTPUT_PATH = OUTPUT_DIR / "draw_profile_comparison.csv"
