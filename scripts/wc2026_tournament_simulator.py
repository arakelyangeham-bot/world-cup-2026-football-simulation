# wc2026_tournament_simulator.py

from dataclasses import dataclass

from scripts.team_strength_loader import load_team_repository
from scripts.wc2026_group_stage import extract_qualifiers_from_standings, simulate_group_stage_with_matches
from scripts.wc2026_knockout_mapping import build_round_of_32
from scripts.wc2026_knockout_stage import (
...
def simulate_round(matches, team_repository):
    return [
        simulate_knockout_match(match, team_repository)
