# models/lightgbm/train_lightgbm.py
...
def train_lightgbm_for_feature_set(feature_set_name, features):
    print(f"\nTraining LightGBM using feature set: {feature_set_name}")
    ...
    return run_experiment(
        ...
        features=features,
        output_dir=ML_OUTPUT_DIR / "lightgbm",
        metadata=metadata,
    )
...
def main():
    ...
    for feature_set_name, features in FEATURE_SETS.items():
        summary_rows.append(
            train_lightgbm_for_feature_set(feature_set_name, features)
        )

    summary_path = ML_OUTPUT_DIR / "lightgbm_summary.csv"
